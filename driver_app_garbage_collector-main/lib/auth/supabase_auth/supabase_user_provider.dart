...
class DriverAppGarbageCollectorNewSupabaseUser extends BaseAuthUser {
  DriverAppGarbageCollectorNewSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> driverAppGarbageCollectorNewSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          DriverAppGarbageCollectorNewSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
