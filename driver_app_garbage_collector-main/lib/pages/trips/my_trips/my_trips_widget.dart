            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Below are your most recent trips',
                ...
                FutureBuilder<List<TripsRow>>(
                  future: FFAppState().fetchDriverTrips(
                    requestFn: () => TripsTable().queryRows(
                      queryFn: (q) => q
                          .eq(
                            'driver_id',
                            currentUserUid,
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, listViewIndex) {
                        final listViewTripsRow =
                            listViewTripsRowList[listViewIndex];
                        return Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 0.0, 16.0, 0.0),
                          child: InkWell(
                            ...
                            onTap: () async {
                              if (listViewTripsRow.status != 'completed') {
                                context.pushNamed(
                                  'ViewTripDetails',
                                  queryParameters: {
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              dateTimeFormat(
                                                'dd-MM-yyyy hh:mm a ',
                                                functions.convertDateToIst(
                                                    listViewTripsRow.updatedAt),
                                                locale:
