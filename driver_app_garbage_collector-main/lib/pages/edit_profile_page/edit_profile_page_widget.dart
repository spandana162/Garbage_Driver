  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<DriversRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DriversRow> editProfilePageDriversRowList = snapshot.data!;
        final editProfilePageDriversRow =
            editProfilePageDriversRowList.isNotEmpty
                ? editProfilePageDriversRowList.first
                : null;
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.fullNameTextController ??=
                                  ...
                                  text: editProfilePageDriversRow?.name,
                                ),
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.phoneNumberTextController ??=
                                    TextEditingController(
                                  text: editProfilePageDriversRow?.phoneNumber,
                                ),
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.updatedRecord != null &&
                                  (_model.updatedRecord)!.isNotEmpty) {
                                ...
                                FFAppState().clearFetchUserDetailsCache();
                                context.safePop();
                              } else {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
